...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Customer Support Console for BBC Store Contact Centre managers and agents</description>
    ...
    <label>BBC Store Support Console</label>
    <listPlacement>
    ...
    <logo>BBCW_Assets/BBC_Store_Logo.jpg</logo>
